...
#define MCP2515_SELECT()   SPI_PORT &= ~(1 << SPI_CAN_SS)
#define MCP2515_UNSELECT() SPI_PORT |= (1 << SPI_CAN_SS)
...
#define CAN_NO_EXT 0    // Not extended message flag
#define CAN_EXT 1       // Extended message flag
#define CAN_NO_RTR 0
#define CAN_RTR 1
